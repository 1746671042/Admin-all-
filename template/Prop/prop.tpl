									...
									<tbody>
										...
										<tr class="hero_list" >
											...
											<td style="text-align: center;line-height: 117px;"><image src="{$v.image}"</td>
                                                                                        <td style="text-align: center;line-height: 117px;">{if $v.type eq 0}全部{elseif $v.type eq 1}攻击{elseif $v.type eq 2}法术{elseif $v.type eq 3}防御{elseif $v.type eq 4}移动{elseif $v.type eq 5}打野{else}辅助{/if}</td>
                                                                                        <td style="text-align: center;line-height: 117px;">{$v.price}</td>
                                                                                        <td style="text-align: center;line-height: 117px;">{$v.total}</td>
                                                                                        <td style="text-align: center;line-height: 117px;">{$v.attribute}</td>
                                                                                        <td style="text-align: center;line-height: 117px;">{$v.decribe}</td>
                                                                                        <td style="text-align: center;line-height: 117px;"><a href="index.php?class=Prop&action=updata&id={$v.id}" id="{$v.id}"><button  class="updata">修改</button></a> | <button id="{$v.id}" style="color: red;" class="delete">删除</button></td>
										</tr>
                                                                            {foreachelse}
                                                                                <tr>
                                                                                    <td>暂无数据</td>
