										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="#" class="form-horizontal">
												...
												<div class="control-group">
													...
													<div class="controls">
                                                                                                           <input type="text" placeholder="请输入修改名称" class="m-wrap small"  name="name" value="{$info.name}"/>
													</div>
												</div>
                                                                                              <div class="control-group">
													<label class="control-label">英雄：</label>
													<div class="controls">
														<input type="text" placeholder="请输入描述" class="m-wrap small"  name="decribe" value="{$info.hero_id}"/>
													</div>
												</div>
                                                                                            <div class="control-group">
													<label class="control-label">排序：</label>
													<div class="controls">
														<input type="text" placeholder="请输入等级" class="m-wrap small"  name="unlock_level" value="{$info.num}"/>
													</div>
												</div>
                                                                                                <div class="control-group">
