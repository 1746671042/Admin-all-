										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form action="#" class="form-horizontal">
												...
												<div class="control-group">
													...
													<div class="controls">
														<input type="text" placeholder="请输入职业" class="m-wrap small"  name="name" value="{$info.name}"/>
													</div>
												</div>
                                                                                                <div class="control-group">
													<label class="control-label">英文名称：</label>
													<div class="controls">
														<input type="text" placeholder="请输入英文职业名称" class="m-wrap small" name="eng_name" value="{$info.eng_name}"/>
													</div>
												</div>
                                                                                                <div class="control-group">
